                        ...
                        <>
                            <div>
                                <p className="text-sm text-justify max-sm:leading-tight">
                                    ...
                                    <a href="https://matrizoffice.com/politica-de-privacidade" target="_blank" rel="noopener noreferrer" className="underline">política de privacidade</a>.
                                </p>
                            </div>
                            <div className="flex sm:gap-10 gap-8 mt-5 justify-center">
                                <button
                                    onClick={handleAcceptAllCookies}
                                    className="block w-fit py-2 px-8 bg-transparent border border-primary text-black text-sm font-semibold uppercase sm:tracking-wider transition-colors duration-300 hover:bg-primary hover:text-black"
                                >
                                ...
                                <div className="flex gap-2 sm:gap-3 mt-6 2xl:mt-8">
                                    ...
                                    <div className="flex gap-3 ml-auto">
                                        <button
                                            ...
                                            className="text-gray-600 text-xs sm:text-sm hover:text-gray-800 transition-colors mr-4"
                                        >
